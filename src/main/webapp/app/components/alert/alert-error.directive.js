(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('raBbvetApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-raBbvetApp-error');
                var entityKey = httpResponse.headers('X-raBbvetApp-params');
                if (errorHeader) {
